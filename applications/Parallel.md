...
-   Implement a cross-asset lending protocol.
-   Support automatic liquidation by using off-chain worker.

| Number | Deliverable                | Specification                                                                                                                                                                                                                 |
| -----: | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|      0 | License                    | Apache 2.0                                                                                                                                                                                                                    |
|    1.a | Substrate module: Loans pallet | Loans pallet will be implemented as a cross-asset lending protocol which offers lending and borrowing by using floating rate model.                                                                                     |
|    1.b | Substrate module: Liquidation pallet | We will implement a liquidation solution build with Substrate Offchain Worker, which will calculates the health factor of each borrower's account and send a liquidation transaction automatically.                                                                                     |
|    1.c | Substrate module: Price aggregation oracle   |  We will need to create a on-chain price aggregation pallet for the oracle prices from multiple source that is queried by off-chain workers.                                                                            |
|    2.a | Integration with front-end | We will integrate our existing front end to the finalized substrate backend                                                                                                                                                   |
|    2.b | Article/Tutorial           | We will create an article and a video demo that explains how users can start using the platform in lending and borrowing for DOT or KSM                                                                                      |
...
|    2.b | Offchain client                     | We will set up multi-signature account on relaychain, and operate the `bond` and `unbond` dispatchables by using offchain client.                                                |
